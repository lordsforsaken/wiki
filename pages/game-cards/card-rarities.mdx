...
|------------|--------|---------|
| Common     | Gray   | <img src={`${process.env.NEXT_PUBLIC_CDN_URL}/cards/webp/v2/silver/Raider.webp`} style={{ maxWidth: '100px', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} /> |
| Rare       | Blue   | <img src={`${process.env.NEXT_PUBLIC_CDN_URL}/cards/webp/v2/silver/Osiris.webp`} style={{ maxWidth: '100px', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} /> |
| Epic       | Pink   | <img src={`${process.env.NEXT_PUBLIC_CDN_URL}/cards/webp/v2/silver/Babi.webp`} style={{ maxWidth: '100px', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} /> |
| Legendary  | Golden | <img src={`${process.env.NEXT_PUBLIC_CDN_URL}/cards/webp/v2/silver/Pythagoras.webp`} style={{ maxWidth: '100px', display: 'block', marginLeft: 'auto', marginRight: 'auto' }}/> |
